...
3. Use the repo's ADR template if one exists. If not, use the minimal sections:
   - `# NNNN Title`
   - `Date`
   - `Status`
   - `Context`
...
Squad consequence: Tal owns CI validation for registry freshness and schema conformance.
```
